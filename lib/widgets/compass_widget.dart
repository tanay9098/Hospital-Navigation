...
class CompassWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer2<PdrProvider, SimulationProvider>(
      builder: (context, pdrProvider, simProvider, child) {
        final heading = simProvider.isSimulating
            ? simProvider.currentHeading
            : pdrProvider.currentHeading;
