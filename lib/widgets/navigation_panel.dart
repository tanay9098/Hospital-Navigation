                                ...
                                _buildActionButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    if (_isSimulationMode) {
                                      // Capture navigator context & destination BEFORE starting,
                                      // because this widget gets unmounted during simulation.
                                      final navContext = Navigator.of(context).context;
                                      final destLabel = settingsProvider.transliterateLabel(navProvider.destinationNode?.label ?? '');
                                      final arrivedText = settingsProvider.translate('nav.arrived_at_short');
                                      ...
                                      // Manual Mode
                                      final startNode = navProvider.startNode;
                                      if (startNode != null) {
                                        Provider.of<PdrProvider>(context, listen: false)
                                            .initializeFallbackPosition(startNode.x, startNode.y, startNode.floor, 0.0);
                                      }
                                      final currentNav = Provider.of<NavigationProvider>(context, listen: false);
                                      Provider.of<PdrProvider>(context, listen: false).togglePdr(true, currentNav);
