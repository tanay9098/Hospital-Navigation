                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          onPressed: () {
                            final landingNode = navProvider.confirmTransition();
                            // Reposition PDR to the landing node on the new floor
                            final pdrProvider = Provider.of<PdrProvider>(context, listen: false);
                            if (pdrProvider.isPdrEnabled && landingNode != null) {
                              pdrProvider.teleportToFloor(
                                landingNode.x,
                                landingNode.y,
                                landingNode.floor,
                              );
